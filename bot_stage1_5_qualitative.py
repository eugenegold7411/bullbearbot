...
_SYSTEM_PROMPT = (
    ...
    "THESIS TAGS TAXONOMY (use only these values):\n"
    "  ai_capex — AI infrastructure build-out spending thesis\n"
    "  earnings_tailwind — positive earnings trend or beat history\n"
    "  earnings_risk — upcoming earnings with high uncertainty\n"
    "  macro_hedge — instrument moves against broad market stress (gold, bonds, VIX)\n"
    "  citrini_thesis — aligned with Citrini Research macro positioning\n"
    "  insider_accumulation — significant insider or congressional buying\n"
    "  insider_distribution — insider or congressional selling (bearish signal)\n"
    "  momentum_continuation — strong price momentum with volume confirmation\n"
    "  mean_reversion — oversold/overbought extreme with catalyst for reversal\n"
    "  sector_rotation — capital rotating into or out of this sector\n"
    "  geopolitical_exposure — significant geopolitical risk or benefit\n"
    "  regulatory_risk — pending regulatory action, FDA review, antitrust\n"
    "  short_squeeze_risk — elevated short interest with potential for rapid covering\n"
    "  commodity_leverage — earnings or revenue directly tied to a commodity price\n"
    "  crypto_correlated — moves with BTC/ETH sentiment\n"
    "  defensive — defensive characteristics (utilities, staples, gold)\n"
    "  rate_sensitive — significantly affected by interest rate moves\n"
    "  earnings_pending — earnings within 5 trading days\n\n"
    "MACRO BETA STRESS RULES:\n"
    "  high: Symbol historically moves 2x or more with broad market (high-beta growth, "
    "leveraged ETFs, speculative crypto). Also: active negative macro catalyst directly "
    "affecting this symbol (tariffs, rate shock, credit event).\n"
    "  medium: Normal correlation with market (most large-cap equities, diversified ETFs). "
    "Or: indirect macro exposure that may affect the thesis.\n"
    "  low: Defensive or uncorrelated instrument (GLD, TLT, utilities, VXX, stablecoins). "
    "Or: company-specific catalyst that dominates macro influence.\n\n"
    "CATALYST ACTIVE RULES:\n"
    "  Use exactly these phrase patterns (≤ 8 words, no numbers, no dates):\n"
    "  'earnings catalyst', 'pre-earnings positioning', 'insider buy signal',\n"
    "  'congressional buy activity', 'AI capex expansion', 'sector rotation in',\n"
    "  'sector rotation out', 'macro hedge demand', 'mean reversion setup',\n"
    "  'short squeeze potential', 'regulatory catalyst pending', 'geopolitical premium',\n"
    "  'commodity price surge', 'momentum continuation', 'post-earnings drift',\n"
    "  null if no active catalyst.\n\n"
    "NARRATIVE RULES:\n"
    "  One sentence maximum. No price levels. No percentage moves. No dates.\n"
    "  Focus on the qualitative 'why' not the quantitative 'what'.\n"
    "  Good: 'Citrini thesis intact; tanker shortage driving premium pricing.'\n"
    "  Bad: 'Stock up 3.2% today to $182; earnings beat by $0.12 on June 4.'\n\n"
    "NULL HANDLING:\n"
    "  Emit null for a symbol when you have NO useful narrative signal for it.\n"
    "  Do not emit an empty context object {} — use null.\n"
    "  Do not emit thesis_tags=[] with a narrative — if you have a narrative, "
    "you should have at least one tag. If tags are genuinely absent, emit null.\n\n"
    "COMPLETENESS REQUIREMENT:\n"
    "  Every symbol in the tracked list must appear in symbol_context — "
    "either as a context object or null. Missing symbols cause pipeline failures.\n"
    "  regime_context is always required — never null.\n"
)
